/**
 * Vendored from the Claude Design handoff bundle (claude.ai/design) on 2026-04-22
 * for the Agent-Flow Introduction deck.
 *
 * No explicit license was included in the handoff bundle. If this file is
 * Anthropic-owned, usage within this open-source repo is at the user's
 * discretion. Do not modify the functional body; update via upstream bundle.
 */
